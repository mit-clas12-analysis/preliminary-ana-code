...
void InitiateHistograms(){
	...
	PrettyTH2F(h2_pe_the    ,"#theta_e [deg]","p_{e} [GeV]"         );
		...
		H_elec_theta_mom = new TH2F("H_elec_theta_mom","H_elec_theta_mom",100,0,EB,100,0,40);
		H_elec_theta_mom->SetTitle("elec #theta vs p");
		H_elec_theta_mom->GetXaxis()->SetTitle("p (GeV)");
		H_elec_theta_mom->GetYaxis()->SetTitle("#theta (^o)");
		H_elec_theta_phi = new TH2F("H_elec_theta_phi","H_elec_theta_phi",100,-180,180,100,0,40);
		H_elec_theta_phi->SetTitle("elec #theta vs #phi");
		H_elec_theta_phi->GetXaxis()->SetTitle("#phi (^o)");
		H_elec_theta_phi->GetYaxis()->SetTitle("#theta (^o)");
		H_elec_phi_mom = new TH2F("H_elec_phi_mom","H_elec_phi_mom",100,0,EB,100,-180,180);
		H_elec_phi_mom->SetTitle("elec #phi vs p");
		H_elec_phi_mom->GetXaxis()->SetTitle("p (GeV)");
		H_elec_phi_mom->GetYaxis()->SetTitle("#phi (^o)");
		H_prot_theta_mom = new TH2F("H_prot_theta_mom","H_prot_theta_mom",100,0,11,100,0,90);
		H_prot_theta_mom->SetTitle("prot #theta vs p");
		H_prot_theta_mom->GetXaxis()->SetTitle("p (GeV)");
		H_prot_theta_mom->GetYaxis()->SetTitle("#theta (^o)");
		H_prot_theta_phi = new TH2F("H_prot_theta_phi","H_prot_theta_phi",100,-180,180,100,0,90);
		H_prot_theta_phi->SetTitle("prot #theta vs #phi");
		H_prot_theta_phi->GetXaxis()->SetTitle("#phi (^o)");
		H_prot_theta_phi->GetYaxis()->SetTitle("#theta (^o)");
		H_prot_phi_mom = new TH2F("H_prot_phi_mom","H_prot_phi_mom",100,0,EB,100,-180,180);
		H_prot_phi_mom->SetTitle("prot #phi vs p");
		H_prot_phi_mom->GetXaxis()->SetTitle("p (GeV)");
		H_prot_phi_mom->GetYaxis()->SetTitle("#phi (^o)");
		H_g_theta_E = new TH2F("H_g_theta_E","H_g_theta_E",100,0,EB,100,0,40);
		H_g_theta_E->SetTitle("#gamma #theta vs p");
		H_g_theta_E->GetXaxis()->SetTitle("p (GeV)");
		H_g_theta_E->GetYaxis()->SetTitle("#theta (^o)");
		H_g_theta_phi = new TH2F("H_g_theta_phi","H_g_theta_phi",100,-180,180,100,0,40);
		H_g_theta_phi->SetTitle("#gamma #theta vs #phi");
		H_g_theta_phi->GetXaxis()->SetTitle("#phi (^o)");
		H_g_theta_phi->GetYaxis()->SetTitle("#theta (^o)");
		H_g_phi_E = new TH2F("H_g_phi_E","H_g_phi_E",100,0,EB,100,-180,180);
		H_g_phi_E->SetTitle("#gamma #phi vs p");
		H_g_phi_E->GetXaxis()->SetTitle("p (GeV)");
		H_g_phi_E->GetYaxis()->SetTitle("#phi (^o)");
		H_g1_theta_E = new TH2F("H_g1_theta_E","H_g1_theta_E",100,0,EB,100,0,40);
		H_g1_theta_E->SetTitle("#gamma1 #theta vs p");
		H_g1_theta_E->GetXaxis()->SetTitle("p (GeV)");
		H_g1_theta_E->GetYaxis()->SetTitle("#theta (^o)");
		H_g1_theta_phi = new TH2F("H_g1_theta_phi","H_g1_theta_phi",100,-180,180,100,0,40);
		H_g1_theta_phi->SetTitle("#gamma1 #theta vs #phi");
		H_g1_theta_phi->GetXaxis()->SetTitle("#phi (^o)");
		H_g1_theta_phi->GetYaxis()->SetTitle("#theta (^o)");
		H_g1_phi_E = new TH2F("H_g1_phi_E","H_g1_phi_E",100,0,EB,100,-180,180);
		H_g1_phi_E->SetTitle("#gamma1 #phi vs p");
		H_g1_phi_E->GetXaxis()->SetTitle("p (GeV)");
		H_g1_phi_E->GetYaxis()->SetTitle("#phi (^o)");
		H_g2_theta_E = new TH2F("H_g2_theta_E","H_g2_theta_E",100,0,EB,100,0,40);
		H_g2_theta_E->SetTitle("#gamma2 #theta vs p");
		H_g2_theta_E->GetXaxis()->SetTitle("p (GeV)");
		H_g2_theta_E->GetYaxis()->SetTitle("#theta (^o)");
		H_g2_theta_phi = new TH2F("H_g2_theta_phi","H_g2_theta_phi",100,-180,180,100,0,40);
		H_g2_theta_phi->SetTitle("#gamma2 #theta vs #phi");
		H_g2_theta_phi->GetXaxis()->SetTitle("#phi (^o)");
		H_g2_theta_phi->GetYaxis()->SetTitle("#theta (^o)");
		H_g2_phi_E = new TH2F("H_g2_phi_E","H_g2_phi_E",100,0,EB,100,-180,180);
		H_g2_phi_E->SetTitle("#gamma2 #phi vs p");
		H_g2_phi_E->GetXaxis()->SetTitle("p (GeV)");
		H_g2_phi_E->GetYaxis()->SetTitle("#phi (^o)");
		H_prot_beta_p = new TH2F("H_prot_beta_p","H_prot_beta_p",100,0,4,100,0,1.2);
		H_prot_beta_p->SetTitle("prot #beta vs p");
		H_prot_beta_p->GetXaxis()->SetTitle("p (GeV)");
		H_prot_beta_p->GetYaxis()->SetTitle("#beta");
		H_phot_b_p = new TH2F("H_phot_b_p","H_phot_b_p",100,0.5,EB,100,0.75,1.25);
		H_phot_b_p->SetTitle("#gamma #beta vs p");
		H_phot_b_p->GetXaxis()->SetTitle("p (GeV)");
		H_phot_b_p->GetYaxis()->SetTitle("#beta");
		H_prot_e_vz = new TH2F("H_prot_e_vz","H_prot_e_vz",100,-25,25,100,-25,25);
		H_prot_e_vz->SetTitle("prot vz vs elec vz");
		H_prot_e_vz->GetXaxis()->SetTitle("elec vz (cm)");
		H_prot_e_vz->GetYaxis()->SetTitle("prot vz (cm)");

		H_prot_miss_phi = new TH2F("H_prot_miss_phi","H_prot_miss_phi",100,-180,180,100,-180,180);
		H_prot_miss_phi->SetTitle("DVCS proton #phi vs miss #phi");
		H_prot_miss_phi->GetXaxis()->SetTitle("proton #phi (^o)");
		H_prot_miss_phi->GetYaxis()->SetTitle("miss #phi (^o)");
		H_phot_elec_angle = new TH2F("H_phot_elec_angle","H_phot_elec_angle",100,-180,180,100,0,40);
	       	H_phot_elec_angle->SetTitle("angle #gamma e vs #phi");
		H_phot_elec_angle->GetXaxis()->SetTitle("#phi Trento (^o)");
		H_phot_elec_angle->GetYaxis()->SetTitle("angle #gamma e (^o)");
		H_phot_virt_angle = new TH2F("H_phot_virt_angle","H_phot_virt_angle",100,0,5,100,0,35);
		H_phot_virt_angle->SetTitle("angle #gamma#gamma^* vs -t");
		H_phot_virt_angle->GetXaxis()->SetTitle("-t (GeV^2)");
		H_phot_virt_angle->GetYaxis()->SetTitle("angle #gamma #gamma^* (^o)");

		H_prot_pi0_miss_phi = new TH2F("H_prot_pi0_miss_phi","H_prot_pi0_miss_phi",100,-180,180,100,-180,180);
		H_prot_pi0_miss_phi->SetTitle("#pi^0 proton #phi vs miss #phi");
		H_prot_pi0_miss_phi->GetXaxis()->SetTitle("proton #phi (^o)");
		H_prot_pi0_miss_phi->GetYaxis()->SetTitle("miss #phi (^o)");
		H_pi0_elec_angle = new TH2F("H_pi0_elec_angle","H_pi0_elec_angle",100,-180,180,100,0,40);
	       	H_pi0_elec_angle->SetTitle("angle #pi^0 e vs #phi");
		H_pi0_elec_angle->GetXaxis()->SetTitle("#phi Trento (^o)");
		H_pi0_elec_angle->GetYaxis()->SetTitle("angle #pi^0 e (^o)");
		H_pi0_virt_angle = new TH2F("H_pi0_virt_angle","H_pi0_virt_angle",100,0,5,100,0,35);
		H_pi0_virt_angle->SetTitle("angle #pi^0#gamma^* vs -t");
		H_pi0_virt_angle->GetXaxis()->SetTitle("-t (GeV^2)");
		H_pi0_virt_angle->GetYaxis()->SetTitle("angle #pi^0 #gamma^* (^o)");

		H_dvcs_Q2xB = new TH2F("H_dvcs_Q2xB","H_dvcs_Q2xB",100,0,1,100,0,12);
		H_dvcs_Q2xB->SetTitle("DVCS Q2 vs xB");
		H_dvcs_Q2xB->GetXaxis()->SetTitle("xB");
		H_dvcs_Q2xB->GetYaxis()->SetTitle("Q2");
		H_dvcs_tphi = new TH2F("H_dvcs_tphi","H_dvcs_tphi",100,-180,180,100,0,5);
		H_dvcs_tphi->SetTitle("DVCS -t vs #phi");
		H_dvcs_tphi->GetXaxis()->SetTitle("#phi (^o)");
		H_dvcs_tphi->GetYaxis()->SetTitle("-t (GeV^2)");
		H_dvcs_pT = new TH1F("H_dvcs_pT","H_dvcs_pT",100,0,1.0);
		H_dvcs_pT->SetTitle("DVCS missing pT");
		H_dvcs_pT->GetXaxis()->SetTitle("pT (GeV)");
		H_dvcs_cone = new TH1F("H_dvcs_cone","H_dvcs_cone",100,0,5);
		H_dvcs_cone->SetTitle("DVCS cone angle");
		H_dvcs_cone->GetXaxis()->SetTitle("cone ang (^o)");
		H_dvcs_copl = new TH1F("H_dvcs_copl","H_dvcs_copl",100,0,30);
		H_dvcs_copl->SetTitle("DVCS copl. angle");
		H_dvcs_copl->GetXaxis()->SetTitle("copl angle (^o)");
		H_dvcs_ME = new TH1F("H_dvcs_ME","H_dvcs_ME",100,-1,2);
		H_dvcs_ME->SetTitle("DVCS miss E");
		H_dvcs_ME->GetXaxis()->SetTitle("miss E (GeV)");
		H_dvcs_MM_ep = new TH1F("H_dvcs_MM_ep","H_dvcs_MM_ep",100,-1,1.2);
		H_dvcs_MM_ep->SetTitle("DVCS ep MM^2");
		H_dvcs_MM_ep->GetXaxis()->SetTitle("ep MM^2 (GeV^2)");
		H_dvcs_MM_eg = new TH1F("H_dvcs_MM_eg","H_dvcs_MM_eg",100,-0.5,4);
		H_dvcs_MM_eg->SetTitle("DVCS e#gamma MM^2");
		H_dvcs_MM_eg->GetXaxis()->SetTitle("e#gamma MM^2 (GeV^2)");
		H_dvcs_MM_epg = new TH1F("H_dvcs_MM_epg","H_dvcs_MM_epg",100,-0.25,0.25);
		H_dvcs_MM_epg->SetTitle("DVCS ep#gamma MM^2");
		H_dvcs_MM_epg->GetXaxis()->SetTitle("ep#gamma MM^2 (GeV^2)");
		H_dvcs_Phi = new TH1F("H_dvcs_Phi","H_dvcs_Phi",100,-180,180);
		H_dvcs_Phi->SetTitle("DVCS phi");
		H_dvcs_Phi->GetXaxis()->SetTitle("#phi (^o)");

		H_pi0_Q2xB = new TH2F("H_pi0_Q2xB","H_pi0_Q2xB",100,0,1,100,0,12);
		H_pi0_Q2xB->SetTitle("DV#pi^0 Q2 vs xB");
		H_pi0_Q2xB->GetXaxis()->SetTitle("xB");
		H_pi0_Q2xB->GetYaxis()->SetTitle("Q2");
		H_pi0_tphi = new TH2F("H_pi0_tphi","H_pi0_tphi",100,-180,180,100,0,5);
		H_pi0_tphi->SetTitle("DV#pi^0 -t vs #phi");
		H_pi0_tphi->GetXaxis()->SetTitle("#phi (^o)");
		H_pi0_tphi->GetYaxis()->SetTitle("-t (GeV)");
		H_gg_open_E = new TH2F("H_gg_open_E","H_gg_open_E",100,0,14,100,0,20);
		H_gg_open_E->SetTitle("DV#pi^0 #gamma#gamma open angle vs E");
		H_gg_open_E->GetXaxis()->SetTitle("E #pi^0 (GeV)");
		H_gg_open_E->GetYaxis()->SetTitle("#gamma#gamma open angle (^o)");
		H_pi0_pT = new TH1F("H_pi0_pT","H_pi0_pT",100,0,2.5);
		H_pi0_pT->SetTitle("DV#pi^0 missing pT");
		H_pi0_pT->GetXaxis()->SetTitle("pT (GeV)");
		H_pi0_cone = new TH1F("H_pi0_cone","H_pi0_cone",100,0,25);
		H_pi0_cone->SetTitle("DV#pi^0 cone angle");
		H_pi0_cone->GetXaxis()->SetTitle("cone ang (^o)");
		H_pi0_copl = new TH1F("H_pi0_copl","H_pi0_copl",100,0,60);
		H_pi0_copl->SetTitle("DV#pi^0 copl angle");
		H_pi0_copl->GetXaxis()->SetTitle("copl ang (^o)");
		H_pi0_ME = new TH1F("H_pi0_ME","H_pi0_ME",100,-5,5);
		H_pi0_ME->SetTitle("DV#pi^0 miss E");
		H_pi0_ME->GetXaxis()->SetTitle("miss E (GeV)");
		H_pi0_MM_ep = new TH1F("H_pi0_MM_ep","H_pi0_MM_ep",100,-3.5,2.5);
		H_pi0_MM_ep->SetTitle("DV#pi^0 ep MM^2");
		H_pi0_MM_ep->GetXaxis()->SetTitle("ep MM^2 (GeV^2)");
		H_pi0_MM_epi0 = new TH1F("H_pi0_MM_epi0","H_pi0_MM_epi0",100,-2.5,7.5);
		H_pi0_MM_epi0->SetTitle("DV#pi^0 e#pi^0 MM^2");
		H_pi0_MM_epi0->GetXaxis()->SetTitle("e#pi^0 MM^2 (GeV^2)");
		H_pi0_MM_eppi0 = new TH1F("H_pi0_MM_eppi0","H_pi0_MM_eppi0",100,-2,1);
		H_pi0_MM_eppi0->SetTitle("DV#pi^0 ep#pi^0 MM");
		H_pi0_MM_eppi0->GetXaxis()->SetTitle("ep#pi^0 MM^2 (GeV^2)");
		H_pi0_Phi = new TH1F("H_pi0_Phi","H_pi0_Phi",100,-180,180);
		H_pi0_Phi->SetTitle("DV#pi^0 #phi");
		H_pi0_Phi->GetXaxis()->SetTitle("#phi (^0)");
		...
		H_dvcs_elec_theta_phi->GetXaxis()->SetTitle("#phi (^o)");
		H_dvcs_elec_theta_phi->GetYaxis()->SetTitle("#theta (^o)");
